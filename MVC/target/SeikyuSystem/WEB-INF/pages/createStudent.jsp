...
<body>
	...
	<section id="contact">
		<div class="section-content">
			...
			<h1 class="section-header">------Update infor of me------</h1>
		</div>
		<div class="contact-section">
			<div class="container">
				<form:form action="${pageContext.request.contextPath}/create"  method="post" modelAttribute="userCreate">
					<div class="col-md-10 form-line">
						...
						<div class="form-group">
							...
							<form:input type="text"	
								path="grade"
								placeholder="grade"
								class="form-control" id="exampleInputGrade" 
								 />
						</div>
						<div class="form-group">
							<label for="exampleInputUsername">User Name</label> 
							<form:input
								type="text" path="username" class="form-control" id="exampleInputUsername"
